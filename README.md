...
In order to use this API, you need to generate a China EMS Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code.  use  China EMS Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [China EMS Tracking API](https://www.trackingmore.com/ems-tracking.html)  to:

   *   Get China EMS realtime tracking info of muti-carriers in one integration
   *   Provide China EMS shipment tracking experience like Amazon
   *   Push China EMS  notifications of package update with webhook
   *   Verify China EMS delivery exception before it is too late
